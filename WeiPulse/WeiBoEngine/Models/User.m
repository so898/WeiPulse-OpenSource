...
@synthesize followme;
@synthesize verified;
@synthesize verifiedType;
@synthesize allowAllActMsg;
@synthesize geoEnabled;
@synthesize userKey;
@synthesize avatarImage;
@synthesize biFollowersCount;
...
- (UserCDItem*)updateUserCDItem:(UserCDItem*)us
{
    ...
    us.followme             = [NSNumber numberWithBool:self.followme];
    ...
    us.verifiedType         = [NSNumber numberWithInt:self.verifiedType];
    us.biFollowersCount     = [NSNumber numberWithInt:self.biFollowersCount];
    us.verifiedReason       = self.verifiedReason;
...
-(User*)updateUserFromUserCDItem:(UserCDItem*)us
{
    ...
    self.followme = us.followme.boolValue;
    ...
    self.verifiedType = us.verifiedType.intValue;
    self.biFollowersCount = us.biFollowersCount.intValue;
    self.verifiedReason = us.verifiedReason;
...
- (void)updateWithJSonDictionary:(NSDictionary*)dic
{
    ...
    biFollowersCount  = ([dic objectForKey:@"bi_followers_count"] == [NSNull null]) ? 0 : [[dic objectForKey:@"bi_followers_count"] longValue];
    ...
    verifiedType    = ([dic objectForKey:@"verified_type"]   == [NSNull null]) ? 0 : [[dic objectForKey:@"verified_type"] longValue];

    following       = ([dic objectForKey:@"following"]       == [NSNull null]) ? 0 : [[dic objectForKey:@"following"] boolValue];
    followme       = ([dic objectForKey:@"follow_me"]       == [NSNull null]) ? 0 : [[dic objectForKey:@"follow_me"] boolValue];
    ...
    if (verified){
        verifiedReason			= [dic objectForKey:@"verified_reason"];
    }
    ...
    if ((id)remark == [NSNull null]) remark = @"";
