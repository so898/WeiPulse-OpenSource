...
- (void)uploadWithLocation:(NSData*)jpeg status:(NSString *)status:(float)latp:(float)longp
{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
						 status, @"status",
                         [NSString stringWithFormat:@"%f", latp], @"lat",
						 [NSString stringWithFormat:@"%f", longp], @"long",
						 _engine.consumerKey, @"source",
                         nil];
	...
	[params setObject:_engine.consumerKey forKey:@"source"];
	[params setObject:status forKey:@"status"];
    [params setObject:[NSString stringWithFormat:@"%f", latp] forKey:@"lat"];
    [params setObject:[NSString stringWithFormat:@"%f", longp] forKey:@"long"];
	//[params setObject:[NSString stringWithFormat:@"%@", statusId] forKey:@"source"];
