...
- (Status*)initWithJsonDictionary:(NSDictionary*)dic {
	if (self = [super init]) {
		...
		//retweetsCount = [[dic getStringValueForKey:@"reposts_count" defaultValue:@""] intValue];
        //NSLog(@"%d",retweetsCount);
        //commentsCount = [[[dic getStringValueForKey:@"comments_count" defaultValue:@""] retain] intValue];
