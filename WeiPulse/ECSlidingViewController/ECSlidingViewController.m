...
@synthesize topCoverViewController      = _topCoverViewController;
...
- (void)setTopViewController:(UIViewController *)theTopViewController
{
  ...
  [self.view addSubview:_topViewController.view];
    ...
    if (self.noticeViewController !=nil){
        [self.view addSubview:self.noticeViewController.view];
    }
    if (self.topCoverViewController !=nil){
        [self.view addSubview:self.topCoverViewController.view];
    }
}

- (void)setCoverViewController:(UIViewController *)theCoverViewController
{
    [_coverViewController.view removeFromSuperview];
    [_coverViewController willMoveToParentViewController:nil];
    [_coverViewController removeFromParentViewController];
    
    _coverViewController = theCoverViewController;
...
- (void)setTopCoverViewController:(UIViewController *)theTopCoverViewController
{
    [_topCoverViewController.view removeFromSuperview];
    [_topCoverViewController willMoveToParentViewController:nil];
    [_topCoverViewController removeFromParentViewController];
    
    _topCoverViewController = theTopCoverViewController;
    
    [self addChildViewController:self.topCoverViewController];
    [self.topCoverViewController didMoveToParentViewController:self];
    [self.view addSubview:_topCoverViewController.view];
}

- (void)setNoticeViewController:(UIViewController *)theNoticeViewController
{
    [_noticeViewController.view removeFromSuperview];
    [_noticeViewController willMoveToParentViewController:nil];
    [_noticeViewController removeFromParentViewController];
    
    _noticeViewController = theNoticeViewController;
    
    [self addChildViewController:self.noticeViewController];
    [self.noticeViewController didMoveToParentViewController:self];
    [self.view addSubview:_noticeViewController.view];
}
...
- (void)addTopViewSnapshot
{
  if (!self.topViewSnapshot.superview && !self.shouldAllowUserInteractionsWhenAnchored) {
    ...
    [self.topView addSubview:self.topViewSnapshot];
      ...
      if (self.noticeViewController !=nil){
          [self.noticeViewController.view removeFromSuperview];
          [self.view addSubview:self.noticeViewController.view];
      }
      if (self.topCoverViewController !=nil){
          [self.topCoverViewController.view removeFromSuperview];
          [self.view addSubview:self.topCoverViewController.view];
      }
  }
}
