...
@property (nonatomic, strong) UIViewController *coverViewController;

@property (nonatomic, strong) UIViewController *topCoverViewController;

@property (nonatomic, strong) UIViewController *noticeViewController;
